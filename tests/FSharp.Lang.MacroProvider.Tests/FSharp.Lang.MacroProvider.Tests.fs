module FSharp.Lang.MacroProviderTests
...
type Generative2 = FSharp.Lang.MacroProvider.GenerativeProvider<2>
type Generative4 = FSharp.Lang.MacroProvider.GenerativeProvider<4>
